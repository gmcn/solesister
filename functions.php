...
function starting_theme_setup() {
	...
	register_nav_menus( array(
		...
		'footer-shop' => esc_html__( 'Footer Shop', 'starting-theme' ),
		'footer-info' => esc_html__( 'Footer Info', 'starting-theme' ),
	) );
...
function starting_theme_widgets_init() {
	...
	register_sidebar( array(
    'name'          => esc_html__( 'Woocommerce Sidebar', 'starting-theme' ),
    'id'            => 'woo-sidebar',
...
function register_acf_block_types() {
    ...
    // Large Boxes w/Image Left
    acf_register_block_type(array(
        'name'              => 'Large Boxes w/Image Left',
        'title'             => __('Large Boxes w/Image Left'),
        'description'       => __('A custom layout block with image left'),
        'render_template'   => 'inc/blocks/large-blocks_img-left.php',
        'category'          => 'formatting',
		...
		// Large Boxes w/Image Left
    acf_register_block_type(array(
        'name'              => 'Large Boxes w/Image Right',
        'title'             => __('Large Boxes w/Image Right'),
        'description'       => __('A custom layout block with image right.'),
        'render_template'   => 'inc/blocks/large-blocks_img-right.php',
        'category'          => 'formatting',
        'icon'              => 'dashicons-grid-view',
        'keywords'          => array( 'testimonial', 'quote' ),
    ));
...
function add_custom_sizes() {
		add_image_size( 'product-front', 260, 340, array( 'center', 'center' ) ); // Hard crop center center
}
